...
class LikesServiceTest {
    ...
    void 좋아요_취소() {
        ...
        Long postId = postService.save(new PostRequestDto(user1.getId(), "테스트를 읽고...", "테스트", "zzyoon",
                LocalDate.of(2023, 5, 14), LocalDate.of(2023, 6, 14), LocalDate.of(2023, 6, 14),
                4, "감상평 테스트1"));

        Long likesId = likesService.save(postId, new LikesSaveRequestDto(user1.getId(), postId));
